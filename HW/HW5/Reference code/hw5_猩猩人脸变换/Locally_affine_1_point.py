# -*- coding: utf-8 -*-
"""
Created on Thu May 25 10:10:33 2017
...
def get_orangutan_message(rows,cols):
	...
	points['mouth_left_corner']={'y':int(0.7*rows),'x':int(0.189*cols)}
	points['mouth_lower_lip_left_contour1']={'y':int(0.844*rows),'x':int(0.3*cols)}
	points['mouth_lower_lip_top']={'y':int(0.933*rows),'x':int(0.478*cols)}
	points['mouth_lower_lip_right_contour1']={'y':int(0.911*rows),'x':int(0.667*cols)}
	points['mouth_right_corner']={'y':int(0.778*rows),'x':int(0.778*cols)}
	return points
